...
class DBStorage:
    ...
    def __init__(self):
        ...
        BACKEND_MYSQL_USER = getenv('BACKEND_MYSQL_USER')
        BACKEND_MYSQL_PWD = getenv('BACKEND_MYSQL_PWD')
        BACKEND_MYSQL_HOST = getenv('BACKEND_MYSQL_HOST')
        BACKEND_MYSQL_DB = getenv('BACKEND_MYSQL_DB')
        self.__engine = create_engine(
            'mysql+mysqldb://{}:{}@{}/{}'.format(BACKEND_MYSQL_USER,
                                                 BACKEND_MYSQL_PWD,
                                                 BACKEND_MYSQL_HOST,
                                                 BACKEND_MYSQL_DB)
        )
